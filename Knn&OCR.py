...
def AreaDeFilasAUnCuarto(tam,mat):#En esta función encontramos el número de píxeles en la fila 1/4
    ...
    uncuarto=float(tam[0]/4)#la variable uncuarto la obtenemos de la division entre cuatro para obtener un cuarto
    ...
    for i in range(0,tam[1]):#for para recorrer la fila que esta a un cuarto de la imagen
        ...
        #fin de condicion if
    #fin de ciclo for
    resultado=cont1/tam[0]
    print("Número de píxeles en la fila a 1/4: ",resultado)
    return resultado#retornamos el valor de nuestro contador 
...
def AreaDeFilasEnMedio(tam,mat):#En esta funcion buscamos encontrar el nùmero de pìxeles en la fila de en medio 
    ...
    enmedio=float(tam[0]/2)#la variable enmedio es el resultado de la matriz entre dos en filas
    ...
    for i in range(0,tam[1]):#For para recorrer las filas
        ...
        #fin de condicion if    
    #fin de ciclo for
    resultado1=cont2/tam[0]
    print("Número de píxeles en la fila de en medio: ",resultado1)
    return resultado1 #retornamos el valor de cuestro contador
...
def AreaDeFilasTresCuartos(tam,mat):#En esta función enconmtramos el número de píxeles en la fila 3/4
    ...
    trescuatro=float((tam[0]/4)*3)#Para obtener tres cuartos de la imagen hacemos la division entre cuatro y la multiplicamos por tres
    ...
    for i in range(0,tam[1]):##for para recorrer la fila que esta a tres cuartos de la imagen
        ...
        #fin de condicion if
    #fin de ciclo for            
    resultado2=cont3/tam[0]            
    print("Número de píxeles en la fila a 3/4: ",resultado2)
    return resultado2#retornamos el valor de nuestro contador         
...
def AreadeColumnasAUnCuarto(tam,mat):#esta funcion buscamos encontrar el nùmero de pìxeles en la columna a 1/4 de la imagen 
    ...
    Cuncuarto=float(tam[1]/4)#La variable Cuncuarto es el resultado de el nùmero de columnas entre cuatro
    ...
    for i in range(0,tam[0]):#For para recorrer las columnas
        ...
        #fin de condicion if
    #fin de ciclo for 
    resultado3=cont4/tam[1]
    print("Número de píxeles en la columna a 1/4: ",resultado3)
    return resultado3#retornamos el valor de nuestro contador 
...
def AreaDeColumnasEnMedio(tam,mat):#En esta funcion buscamos encontrar el nùmero de pìxeles en la columna de en medio 
    ...
    Cenmedio=float(tam[1]/2)#La variable Cenmedio es el resultado de la matriz entre dos en Columnas
    ...
    for i in range(0,tam[0]):#For para recorrer las columnas
        ...
        #fin de condicion if
    #fin de ciclo for 
    resultado4=cont5/tam[1]
    print("Número de píxeles en la columna de en medio: ",resultado4)
    return resultado4#retornamos el valor de nuestro contador
...
def AreaDeColumnasTresCuartos(tam,mat):#esta funcion buscamos encontrar el nùmero de pìxeles en la columna a 3/4 de la imagen 
    ...
    Ctrescuatro=float((tam[1]/4)*3)#La variable Ctrescuartos hacemos la division del nùmero de columnas entre cuatro y lo multiplicamos por tres
    ...
    for i in range(0,tam[0]):#for para poder recorrer las columnas 
        ...
        #fin de condicion if
    #fin de ciclo for 
    resultado5=cont6/tam[1]
    print("Número de píxeles en la columna a 3/4: ",resultado5)
    return resultado5#Retornamos el valor de nuestro contador
...
def knn(Razon,area,FCorteC,FCorteM,FCorteTC,CCortesC,CCortesM,CCortesTC,AFilasC,AFilasM,AFilasTC,AColumnasC,AColumnasM,AColumnasTC):
    ...
    for i in dataset:#for para poder recorrer el dataset en todas las posiciones    
        ...
        dataset[contador][1]=float(dataset[contador][1])#Convertirmos a entero dataset en su posición [contador][1]
        dataset[contador][2]=float(dataset[contador][2])#Convertirmos a entero dataset en su posición [contador][2]
        dataset[contador][3]=float(dataset[contador][3])#Convertirmos a entero dataset en su posición [contador][3]
        dataset[contador][4]=float(dataset[contador][4])#Convertirmos a entero dataset en su posición [contador][4]
        dataset[contador][5]=float(dataset[contador][5])#Convertirmos a entero dataset en su posición [contador][5]
        dataset[contador][6]=float(dataset[contador][6])#Convertirmos a entero dataset en su posición [contador][6]
        dataset[contador][7]=float(dataset[contador][7])#Convertirmos a entero dataset en su posición [contador][7]
        dataset[contador][8]=float(dataset[contador][8])#Convertirmos a entero dataset en su posición [contador][8]
        dataset[contador][9]=float(dataset[contador][9])#Convertirmos a entero dataset en su posición [contador][9]
        dataset[contador][10]=float(dataset[contador][10])#Convertirmos a entero dataset en su posición [contador][10]
        dataset[contador][11]=float(dataset[contador][11])#Convertirmos a entero dataset en su posición [contador][11]
        dataset[contador][12]=float(dataset[contador][12])#Convertirmos a entero dataset en su posición [contador][12]
        dataset[contador][13]=float(dataset[contador][13])#Convertirmos a entero dataset en su posición [contador][13]
        dataset[contador][14]=float(dataset[contador][14])#Convertirmos a entero dataset en su posición [contador][14]
